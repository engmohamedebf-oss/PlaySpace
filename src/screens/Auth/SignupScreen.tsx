			...
			<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
				<ScrollView contentContainerStyle={{ padding: theme.spacing.xl, flexGrow: 1, justifyContent: 'center' }} keyboardShouldPersistTaps="handled">
					<View style={{ backgroundColor: theme.colors.panel, borderRadius: theme.radii.lg, padding: theme.spacing.xl }}>
						<Text style={{ color: '#fff', fontSize: theme.typography.heading.sizes.lg, fontWeight: '700', marginBottom: theme.spacing.lg }}>Sign Up</Text>
						...
						<Button variant="primary" onPress={onSignup} loading={loading} accessibilityLabel="Sign Up">
							Sign Up
						</Button>
						<Button variant="ghost" onPress={() => navigation.goBack()} accessibilityLabel="Go back">
							Back
						</Button>
					</View>
				</ScrollView>
